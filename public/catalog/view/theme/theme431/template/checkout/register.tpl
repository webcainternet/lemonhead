...
<div style="clear: both; padding-top: 15px; border-top: 1px solid #EEEEEE;">
  ...
  <label class="checkbox" for="shipping"><?php echo $entry_shipping; ?><input type="checkbox" name="shipping_address" value="1" id="shipping" checked="checked" /></label>
...
$('#payment-address select[name=\'country_id\']').bind('change', function() {
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme431/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			

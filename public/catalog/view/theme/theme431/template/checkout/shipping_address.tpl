<?php if ($addresses) { ?>
<label class="radio" ><?php echo $text_address_existing; ?>
...
<p>
	<label class="radio" ><?php echo $text_address_new; ?>
...
<div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  <div class="form form-horizontal">
		...
		<div class="form-group">
			<label class="control-label col-sm-5" ><span id="shipping-postcode-required" class="required">*</span> <?php echo $entry_postcode; ?></label>
			<div class="controls col-sm-7">
...
$('#shipping-address select[name=\'country_id\']').bind('change', function() {
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#shipping-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme431/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			

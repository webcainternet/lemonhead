  ...
  <table class="compare-info table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/theme431/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
    ...
    <tr>
      <td></td>
      <?php foreach ($products as $product) { ?>
      <td class="tcenter"><a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button"><span><?php echo $button_cart; ?></span></a></td>
      <?php } ?>
    </tr>
    <tr>
      <td class="last-1"></td>
      <?php foreach ($products as $product) { ?>
      <td class="remove last-1 tcenter"><a href="<?php echo $product['remove']; ?>" ><i class="fa fa-trash-o-o"></i><!--<?php echo $button_remove; ?>--></a></td>
      <?php } ?>
    </tr>
  </table>
  </div>

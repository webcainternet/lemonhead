		...
		<div class="content">
		  <table class="form">
			...
			<tr id="company-id-display">
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" ><span id="company-id-required" class="required">*</span> <?php echo $entry_company_id; ?></label>
						<div class="controls col-sm-7">
			...
			<tr id="tax-id-display">
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" ><span id="tax-id-required" class="required">*</span> <?php echo $entry_tax_id; ?></label>
						<div class="controls col-sm-7">
		...
		<div class="content">
		  <table class="form">
			<tr>
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" ><?php echo $entry_newsletter; ?></label>
						<div class="controls col-sm-7">
							<?php if ($newsletter) { ?>
...
$('select[name=\'country_id\']').bind('change', function() {
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme431/image/loading.gif"  /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			
